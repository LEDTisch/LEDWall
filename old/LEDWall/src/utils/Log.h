...
enum DEBUG_LEVEL{TIME_AUSGABE=true, APPLICATION_MANAGE_INFO=true, ESP_ARDUINO_CONNECTION_INFO=true, ESP_ARDUINO_CONNECTION_DEBUG=false, ESP_ARDUINO_CONNECTION_ERROR=true, SNAKE_GAME_DEBUG=false};
